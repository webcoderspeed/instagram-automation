...
// Subscription Status const object
...
userSchema.methods.generateEmailVerificationToken = function(this: UserDocument): string {
  // Implementation would generate a secure token
...
userSchema.methods.resetLoginAttempts = async function(this: UserDocument): Promise<UserDocument> {
  this.loginAttempts = 0;
  this.lockUntil = undefined;
  return this.save();
};

userSchema.methods.updateLastLogin = async function(this: UserDocument, ip?: string): Promise<UserDocument> {
...
userSchema.methods.restore = async function(this: UserDocument): Promise<UserDocument> {
  this.deletedAt = undefined;
  return this.save();
};

userSchema.methods.toPublicJSON = function(this: UserDocument): Record<string, unknown> {
